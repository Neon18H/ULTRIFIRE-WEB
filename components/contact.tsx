...
export function Contact() {
  return (
    <section id="contacto" className="relative overflow-hidden px-4 py-24 sm:px-6">
      <div className="absolute inset-x-0 top-1/2 h-72 -translate-y-1/2 bg-gradient-to-r from-bluefire/20 via-cyanfire/15 to-violetfire/20 blur-[110px]" aria-hidden="true" />
      <Reveal className="relative mx-auto grid max-w-7xl gap-8 overflow-hidden rounded-[2.25rem] border border-cyanfire/25 bg-gradient-to-br from-panel via-[#07142A] to-night p-6 shadow-glow-strong sm:p-10 lg:grid-cols-[0.9fr_1.1fr] lg:p-12">
        ...
        <div className="relative">
          ...
          <h2 className="font-display text-4xl font-bold tracking-[-0.05em] text-white sm:text-5xl">Protege tu empresa hoy.</h2>
        ...
        >
          ...
          <button type="submit" className="focus-ring group mt-2 inline-flex items-center justify-center rounded-2xl bg-gradient-to-r from-bluefire to-cyanfire px-6 py-4 text-sm font-bold text-white shadow-glow transition hover:-translate-y-1 hover:shadow-glow-strong">
            Solicitar Demo
