      ...
      <div className="mx-auto max-w-7xl">
        ...
        <div className="relative grid gap-8 lg:grid-cols-3 lg:gap-12">
          ...
          {steps.map((step, index) => (
            <Reveal key={step.title} delay={index * 0.08} className="relative border border-line/75 bg-deep/75 p-6 shadow-soft backdrop-blur-xl lg:border-0 lg:bg-deep/80 lg:pr-6">
